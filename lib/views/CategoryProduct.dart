                    ...
                    itemBuilder: (context, index) {
                      return Container(
                        ...
                        child: Column(
                          children: [
                            Image.network(
                              GlobalVariable.URL + data[index].coverPhoto,
                            ...
                            GestureDetector(
                              onTap: () async {
                                ...
                                double totalPrice = prefs.getString("price") ==
                                        null
                                    ? 0.0
                                    : double.parse(prefs.getString("price"));
                                CartMedelLocal p1 = new CartMedelLocal({
                                  ...
                                  "totalPrice": double.parse(
                                      (data[index].counter * data[index].price)
                                          .toString()),
                                  "quantity": data[index].counter
                                });
                                try {
                                  GlobalFunction.UpdateTotalPrices(double.parse(
                                      (data[index].counter * data[index].price)
                                          .toString()));
                                  await dbHelper.addToCart(p1);
                                  GlobalFunction.addProductDialog(
                                    context,
                                    data[index].counter,
                                    data[index].name,
                                  );
                                  setState(() {
                                    ParentPage.TotalPrice =
                                        double.parse(prefs.getString("price"));
                                  });
                                } catch (e) {
                    ...
                    children: [
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            CustomText.text12Bold(
                                ParentPage.TotalPrice == null
                                    ? "00 رس "
                                    : "${ParentPage.TotalPrice}رس ",
                                Colors.black),
                            //SizedBox(width: 2,),
