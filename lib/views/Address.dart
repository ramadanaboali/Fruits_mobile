...
class _state extends State<Address>{
  ...
  loadData()async{
    ...
    addressList=await addressServices.GetAddress(pref.getString("lang"), pref.getString("UserId"));
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        body: addressList==null?Center(child: CircularProgressIndicator(),):Container(
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          SizedBox(width: 5,),
                          CustomText.titleTextColor(DemoLocalizations.of(context).title['DeliveryAddress'],Color(h.mainColor)),
                        ],
                      ),
                      GestureDetector(
                        onTap: (){
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        child: Column(
                          children: [
                                 ...
                                 return      GestureDetector(
                                   ...
                                   child: Container(
                                     ...
                                     child: Row(
                                       mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                       children: [
                                         Radio(value: addressList[index],groupValue: SelectedAddress,onChanged: (val){setState(() {
                                          SelectedAddress=addressList[index];
                                         ...
                                         Container(
                                           ...
                                           child: Text(addressList[index].address,maxLines: 1,),
                                         ),
                            ...
                            GestureDetector(
                              onTap: (){
                                Navigator.push(context, GlobalFunction.route(AddAdress(this.items)));
                              },
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      children: [
                                        Text(DemoLocalizations.of(context).title['addnewaddress'],style: TextStyle(decoration: TextDecoration.underline),),
                      ...
                      Container(
                          ...
                          child: Row(
                            children: [
                              CustomText.btnText(DemoLocalizations.of(context).title['paymentmethod'], Colors.white),
                            ],
                          )
                      ),
                      SizedBox(height: MediaQuery.of(context).size.height*.01,),
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        Radio(value: paymentList[index].id,groupValue: payment,onChanged: (val){setState(() {
                                          payment=val;
                                        });},activeColor: Color(h.mainColor),),
                                        CustomText.text12Bold(paymentList[index].name, payment==paymentList[index].name?Color(h.mainColor):Colors.black54),
                                      ],
                                    ),
                                    Image.asset("images/visa.png",width: 50,height: 20,color: payment==paymentList[index].name?Color(h.mainColor):Colors.black54,)
                      ...
                      Container(
                          ...
                          child: Row(
                            children: [
                              CustomText.btnText(DemoLocalizations.of(context).title['deliveryTime'], Colors.white),
                            ],
                          )
                      ),
                      Container(
                      ...
                      GestureDetector(
                        onTap: ()async{
                            ...
                            Navigator.push(context, GlobalFunction.route(ConfirmOrder(this.items,this.payment,this.SelectedAddress,this.time)));
                        ...
                        child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                CustomText.btnText(DemoLocalizations.of(context).title['confirmOrder'], Colors.white),
                              ],
                            )
                        ),
                      ),
